...
function bookingArt(variant: 0 | 1, slot: number, alt: string): string {
  ...
  const defs = `<linearGradient id="bk${s}" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#eef3ea"/><stop offset="1" stop-color="#c9d6c8"/></linearGradient>`;
  if (s === 1) {
    return wrap(id, alt, `<g data-room="${room}"><rect width="640" height="420" fill="#1f6f68"/><rect data-part="seat" x="80" y="140" width="200" height="160" rx="18" fill="#eef3ea"/><rect data-part="window" x="340" y="70" width="240" height="160" rx="16" fill="#c9d6c8"/><path d="M370 110h180M370 140h120" stroke="#1a2a24" stroke-width="6" stroke-linecap="round"/><circle cx="180" cy="300" r="40" fill="#eef3ea"/></g>`, s, defs);
  }
  if (s === 2) {
    return wrap(id, alt, `<g data-room="${room}"><rect width="640" height="420" fill="#164f4a"/><circle data-part="clock" cx="320" cy="190" r="110" fill="#eef3ea"/><circle cx="320" cy="190" r="8" fill="#1a2a24"/><path d="M320 190 L320 120 M320 190 L372 214" stroke="#1a2a24" stroke-width="6" stroke-linecap="round"/><rect x="70" y="330" width="200" height="10" fill="#1a2a24"/></g>`, s, defs);
  }
  if (s === 3) {
    return wrap(id, alt, `<g data-room="${room}"><rect width="640" height="420" fill="#1f6f68"/><rect data-part="window" x="70" y="56" width="500" height="260" rx="8" fill="url(#bk${s})"/><path d="M70 186h500" stroke="#1a2a24" stroke-width="8"/><path d="M320 56v260" stroke="#1a2a24" stroke-width="8"/><rect x="96" y="330" width="240" height="12" fill="#1a2a24"/></g>`, s, defs);
  }
  return wrap(id, alt, `<g data-room="${room}"><rect width="640" height="420" fill="#1f6f68"/><rect data-part="seat" x="36" y="48" width="280" height="200" rx="18" fill="#eef3ea"/><rect x="70" y="80" width="90" height="130" rx="8" fill="#1a2a24"/><rect x="180" y="120" width="100" height="90" rx="10" fill="#c9d6c8"/><circle cx="170" cy="300" r="${36 + s * 4}" fill="#eef3ea"/><rect data-part="window" x="340" y="70" width="240" height="160" rx="16" fill="#c9d6c8"/><path d="M370 110h180M370 140h120" stroke="#1a2a24" stroke-width="6" stroke-linecap="round"/><rect x="70" y="330" width="200" height="10" fill="#1a2a24"/></g>`, s, defs);
}
