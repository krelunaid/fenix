...
const MOTIFS: { test: RegExp; d: string }[] = [
  ...
  { test: /parrucchier|barbiere|barbieri|\bbarber(?:\s*shop)?\b|\bhair\s*salon\b/i, d: "M12.2 18.8 24.6 4.4c.62-.7 1.78-.58 2.22.26l.62 1.12c.36.64.08 1.46-.58 1.84L14.1 20.2z" },
