...
export const FASE3_GAPS: Fase3Gap[] = [
  ...
  },
  {
    ...
    fenix:
      "Contratto di build v1 (planner deterministico, 0 token) + ruoli grok-build-0.1 con ricevute, niente CoT. Evaluator su 6 fixture: gestionale CRUD, mobile, multi-file, utility, gioco e portfolio; 18 percorsi funzionali D/T/M con console, overflow, focus e target misurati. Gate condiviso API/Edge: blocking ContractCheck ferma t:ok/ready/Pubblica. File extra solo se il brief li chiede. AA fail-closed. Critic LLM saltato se i gate statici passano. Repair max 2. Collection Fenix.data: set canonico ristretto; Vesti «capi vesti» via COL è riscritto in «capi», i token con slash restano fail-closed, patch su nodo assente/invariato non ripetono giri. Ledger in quality-ledger.ts.",
    impact: "high",
    cost: "medium",
    slice: "now",
  },
