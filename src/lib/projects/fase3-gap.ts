...
export const FASE3_GAPS: Fase3Gap[] = [
  {
    ...
    fenix: "Prima di questo slice: un solo html corrente. Nessuna cottura precedente.",
    impact: "high",
    cost: "medium",
    slice: "now",
  },
  {
    ...
    fenix: "HTML denormalizzato + files[] (max 24 dal parser). Tree estendibile in revisions.",
    impact: "high",
    cost: "high",
    slice: "next",
  },
  {
    ...
    fenix: "ZIP locale. Nessun OAuth GitHub sul prodotto (non si inventano credenziali).",
    impact: "high",
    cost: "medium",
    slice: "next",
  },
  {
    ...
    fenix: "Fenix.load/save IndexedDB nel runtime. Auth Fenix è del titolare, non dell'app generata.",
    impact: "high",
    cost: "high",
    slice: "later",
  },
