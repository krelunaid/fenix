...
export const FASE3_GAPS: Fase3Gap[] = [
  ...
  },
  {
    ...
    fenix: "Contratto di build v1 (planner deterministico, 0 token) + ruoli grok-build-0.1 con ricevute, niente CoT. Evaluator su 3 fixture (kiln CRUD, grottaglie mobile, kiln+mock multi-file). Gate condiviso API/Edge: blocking ContractCheck ferma t:ok/ready/Pubblica. File-tree atteso obbligatorio. AA fail-closed. Critic LLM saltato se i gate statici passano. Repair max 2. Ledger in quality-ledger.ts.",
    impact: "high",
    cost: "medium",
    slice: "now",
  },
