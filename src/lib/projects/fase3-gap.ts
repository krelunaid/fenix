...
export const FASE3_GAPS: Fase3Gap[] = [
  ...
  },
  {
    ...
    fenix: "Albero POSIX durevole: ingest (no .., no assoluti, no secret/binari, 48 file / 1.5MB). Entrypoint index.html, migrazione HTML-only senza perdere kind/storage/publish. ZIP+fenix.json. Studio ispeziona l'albero D/T/M. Preview/publish solo HTML validato.",
    impact: "high",
    cost: "high",
    slice: "now",
  },
  {
    ...
    fenix: "ZIP locale con manifest. Nessun OAuth GitHub sul prodotto (non si inventano credenziali).",
    impact: "high",
    cost: "medium",
    slice: "next",
  },
