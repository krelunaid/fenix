...
html[data-grammar] .app-mark{background:var(--elevated);color:var(--fg);border:1px solid var(--line);box-shadow:none;border-radius:12px}
...
html[data-grammar="agenda"] .slot{border:0;border-bottom:1px solid color-mix(in srgb,var(--line) 75%,transparent);border-radius:0;box-shadow:none;background:transparent;margin:0}
...
html[data-grammar="agenda"] .slot .time{color:var(--fg);font-size:15px;font-weight:650}
