...
- `01-home.png` — surfaceSecondary page, greeting without Ciao, two `surfaceInverse` cards, tile overlays, translucent tank toggle, electric fill, success green
...
Home uses those slots. Greeting is `Missioni` / `Quadro di controllo` — **no Ciao**, no invented Andrea. Home tab is a drop only on campo. Five tabs stay.
