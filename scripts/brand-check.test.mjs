...
const skipOgSkill = !existsSync(OG_SKILL);
...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: skipOgSkill }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: skipOgSkill }, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", { skip: skipOgSkill }, () => {
